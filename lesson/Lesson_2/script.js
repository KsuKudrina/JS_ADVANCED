...
// Если значение не определено или равно null или undefined, используется значение поумолчанию
...
console.log (streetName); // Выводит '123 Main St', так как свойство 'street' существует в объекте