      ...
      //   const isWindowOpen =
      //     window.window.open("https://www.example.com") !== null; // Проверяет, открыто ли окно
      ...
      //   const parentWindow = window.parent; // Получает доступ к родительскому окну из фреймад
      ...
      // // Из прошлой части
    //   console.log(window.Symbol.for); // f for() { [native codel }
    //   console.log(window.Symbol.iterator); // Symbol (Symbol. iterator)
    //   console.log(window.Array.from); // f from() & [native codel }